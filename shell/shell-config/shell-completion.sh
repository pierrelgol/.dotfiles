...
'-h[Print help]' \
'--help[Print help]' \
'*::period -- Compute statistics for the specified period, leave blank for statistics since the beginning. See https\://docs.atuin.sh/reference/stats/ for more details:' \
&& ret=0
;;
(search)
_arguments "${_arguments_options[@]}" \
